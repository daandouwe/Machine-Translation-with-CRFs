...
class Symbol:
    ...
    def __new__(cls, key, args):
        ...
        if instance is None:
            instance = cls.constructor(cls, *args)
...
Symbol.__getnewargs__ = lambda self: (self.key, self.args)
...
class Terminal(Symbol):
    ...
    def __new__(cls, symbol: str):
        ...
        return super(Terminal, cls).__new__(cls, symbol, [symbol])

    def constructor(cls, symbol):
...
Terminal.__getnewargs__ = lambda self: (self._symbol, )
...
class Nonterminal(Symbol):
    ...
    def __new__(cls, symbol: str):
        ...
        return super(Nonterminal, cls).__new__(cls, symbol, [symbol])
...
Nonterminal.__getnewargs__ = lambda self: (self._symbol, )
...
class Span(Symbol):
    ...
    def __new__(cls, symbol: Symbol, start: int, end: int):
        ...
        return super(Span, cls).__new__(cls, (symbol, start, end), [symbol, start, end])

    def constructor(cls, symbol, start, end):
...
Span.__getnewargs__ = lambda self: (self._symbol, self._start, self._end)
...
Rule.__getnewargs__ = lambda self: (self.lhs, self.rhs)
...
CFG.__getnewargs__ = lambda self: (self._rules, )
